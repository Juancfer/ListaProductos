...
// Contexto de login
export const AuthContext = React.createContext({ user: null, favProduct: "" });

function App() {
  // Estado del login
  const [authInfo, setAuthInfo] = React.useState({ user: null, favProduct: "" });
      ...
      <div className="app">
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path='/product-detail/:id' element={<React.Suspense fallback={<p>Cargando...</p>}> <ProductDetail userProfile={setAuthInfo}></ProductDetail> </React.Suspense>}></Route>
